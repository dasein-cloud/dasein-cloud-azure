...
/**
 * Created by Jeffrey Yan on 2/29/2016.
 *
 * @author Jeffrey Yan
 * @since 2016.02.1
 */
...
public class CreateDatabaseRecoveryModel {
    @XmlElement(name="SourceDatabaseName", namespace ="http://schemas.microsoft.com/windowsazure")
    private String sourceDatabaseName;

    @XmlElement(name="TargetServerName", namespace ="http://schemas.microsoft.com/windowsazure")
